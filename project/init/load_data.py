...
def main():
    ...
    # Source call_code is a synthetic training label only. It is intentionally
    # not loaded into the operational CDC path; downstream analytics must use
    # call_code generated by the NLP model from call_transcript.
